# 👋 Hi, I’m Hareini Sankar

I’m a 2nd-year **AI & DS student** passionate about building **AI-powered applications, generative AI projects, and interactive web solutions**. I love experimenting with new technologies, learning **prompt engineering**, and developing **full-stack applications**.  
...
- DOM manipulation & event handling (e.g., “Add to Cart” functionality)  
- Building interactive websites: search bars, carousels, forms, contact pages  
- Learning ReactJS prerequisites  

### 4️⃣ Data Structures & Algorithms (DSA)
- Basics: arrays, linked lists, stacks, pointers  
- Problem solving: palindrome checks, pair sum, traversals, max/sum, search, delete  
- Improving coding consistency & syntax skills  

### 5️⃣ Communication & Interview Skills
- Enhancing technical communication, presentation skills, and accent improvement  
...
### Tools & Platforms
Git, GitHub, JSON, Prompt Engineering, Zapier, Google Colab  
...
## 🏆 Achievements
- 🏅 **Finalist**, TNWISE Women Hackathon  
...
**Creative text style converter using Google FLAN-T5**  
...
- 🔗 **LinkedIn:** [Hareini Sankar](https://www.linkedin.com/in/hareini-sankar-082a27348/)  
- 🐙 **GitHub:** [Hareini](https://github.com/Hareini)  
